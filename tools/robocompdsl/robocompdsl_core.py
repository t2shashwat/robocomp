								...
								if len(method['params']) == 2:
									for f in [ "SERVANT.SRV"]:
										...
										if ret != 0:
											...
											sys.exit(-1)
										replaceTagsInFile(ofile)
										commandCPP = "/opt/ros/melodic/lib/gencpp/gen_cpp.py " +ofile+ " -Istd_msgs:/opt/ros/melodic/share/std_msgs/msg -Istd_srvs:/opt/ros/melodic/share/std_srv/srv -I" + idsl['module']['name'] + "ROS:" + outputPath
										commandPY  = "/opt/ros/melodic/lib/genpy/gensrv_py.py " +ofile+ " -Istd_msgs:/opt/ros/melodic/share/std_msgs/msg -Istd_srvs:/opt/ros/melodic/share/std_srv/srv -I" + idsl['module']['name'] + "ROS:" + outputPath
										for impo in imported:
											if not impo == idsl['module']['name']+"ROS":
												commandCPP = commandCPP + " -I" + impo + ":" + outputPath
												commandPY  = commandPY + " -I" + impo + ":" + outputPath
